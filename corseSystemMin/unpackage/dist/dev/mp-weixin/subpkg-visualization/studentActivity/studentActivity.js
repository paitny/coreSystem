  ...
  computed: {
    ...
    list() {
      return this.list.filter(
        (item) => item.institution.toLowerCase().includes(this.keyword.toLowerCase())
      );
    }
  },
  methods: {
    getuserInfo() {
      common_vendor.index.$http.get("/api/itVolunteer/volunteersID", {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.sr("searchBar", "8ff920e4-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-8ff920e4"]]);
