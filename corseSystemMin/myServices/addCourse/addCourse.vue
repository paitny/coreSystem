<template>
	<view class="container">
		<view class="info-box">
			...
			<view class="info-list">
				...
				<view class="info-item" @click="showPopup1">
					...
					<view class="">{{convertToChineseNumber(info.week)}}</view>
				</view>
		...
		<button class="add-btn" @click="subCourse">添加</button>
	...
	export default {
		...
		methods: {
			...
			subCourse() {
				...
				} else if (this.info.week === undefined || this.info.week === null || isNaN(this.info.week)) {
					return uni.showToast({
						title: '无星期',
						icon: 'error',
						duration: 1500 // 持续时间为1.5秒
